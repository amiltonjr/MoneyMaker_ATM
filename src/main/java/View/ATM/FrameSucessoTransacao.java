 ...
 */
public class FrameSucessoTransacao extends javax.swing.JFrame {

    private static final long serialVersionUID = 1L;
    private FrameMenuOperacoes parentFrame;
    
    /**
     * Creates new form FrameSucessoTransacao
     */
    public FrameSucessoTransacao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblErroLeitura1.setText("Transação efetuada com sucesso");

        lblIconeErroLeitura1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icones/ok.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSucessoTransacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameSucessoTransacao().setVisible(true);
            }
        });
    }
